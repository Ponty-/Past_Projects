...
spid=$!
$bindir/client499 A game $port > $res/$name.a.out 2>$res/$name.a.err < ipamoves &
pid1=$!
$bindir/client499 B game $port > $res/$name.b.out 2>$res/$name.b.err < ipbmoves &
pid2=$!
$bindir/client499 C game $port > $res/$name.c.out 2>$res/$name.c.err < ipcmoves &
pid3=$!
$bindir/client499 D game $port > $res/$name.d.out 2>$res/$name.d.err < ipdmoves &
pid4=$!
