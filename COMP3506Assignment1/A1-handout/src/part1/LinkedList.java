...
public class LinkedList<E> implements PositionList<E> {
	...
	public void addAfter(Position<E> p, E e) throws InvalidPositionException {
		if (p == tail){//New tail wasn't being set if adding after last element
			addLast(e);
			return;
		}
	...
	public void addBefore(Position<E> p, E e) throws InvalidPositionException {
		if (p == head){//New head wasn't being set if adding before head
			addFirst(e);
			return;
		}		
	...
	public E remove(Position<E> p) throws InvalidPositionException {
		...
		if (before != null) before.setNext(after); //Wasn't checking if before and after
		if (after != null) after.setPrev(before); //were null before running methods
		if (n == head) {
			head = after;
		}
		if (n == tail) {
